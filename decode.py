...
import os
import subprocess
from utils import data_preap, feature_extraction, data2json, decode, getResults
...
def main(args):
    ...
    # cmvn file
    cmvn = args.cmvn
    feature_extraction(data_dir, cmvn, decode_dir + '/log_dir', decode_dir, nj=1)
    ...
    getResults(decode_dir + '/results.json', decode_dir + '/results.text')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nj', type=int, default=1, help='the number of processes')
